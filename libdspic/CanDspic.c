...
void ChargerFiltre(unsigned char numero, unsigned int id);
...
void CanDeclarationProduction(unsigned int id, void *ptrData, unsigned char len)
{
...
void CanDeclarationConsommation(unsigned int id, void *ptrData, unsigned char len)
{
...
void CanInitialisation(unsigned char CanID)
{
	...
	CanSetBaudRate(CAN_BAUDRATE_125k);
